...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            logging.info(f"Actual number of columns: {actual_columns}")
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            if not train_status:
                error_message = "Train number of columns doesn't match."

            test_status = self.validate_number_of_columns(test_dataframe)
            if not test_status:
                error_message = "Test number of columns doesn't match."
